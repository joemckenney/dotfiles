...
-- [[ Ported keymaps from old init.vim ]]
-- Fat finger commands
...
-- Paste without losing register (p then reselect and yank)
vim.keymap.set('x', 'p', 'pgvy', { desc = 'Paste and keep register' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Ctrl+P for file search (ported from old fzf config)
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        -- TypeScript/JavaScript (replaces coc-tsserver)
        ts_ls = {},

        -- Go (replaces vim-go)
        gopls = {},

        -- Rust (replaces rust.vim + rustfmt)
        rust_analyzer = {
          settings = {
            ['rust-analyzer'] = {
              checkOnSave = {
        ...
        -- Python (replaces coc-python)
        pyright = {},

        -- HTML/CSS/JSON (replaces coc-html, coc-css, coc-json)
        html = {},
        cssls = {},
        jsonls = {},

        -- Prisma (replaces coc-prisma)
        prismals = {},

        -- ESLint (replaces coc-eslint)
        eslint = {},
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        lua = { 'stylua' },
        -- TypeScript/JavaScript - prefer biome, fallback to prettier
        javascript = { 'biome', 'prettierd', 'prettier', stop_after_first = true },
        typescript = { 'biome', 'prettierd', 'prettier', stop_after_first = true },
        javascriptreact = { 'biome', 'prettierd', 'prettier', stop_after_first = true },
        typescriptreact = { 'biome', 'prettierd', 'prettier', stop_after_first = true },
        json = { 'biome', 'prettierd', 'prettier', stop_after_first = true },
        -- Python (replaces psf/black)
        python = { 'black' },
        -- Rust (rustfmt)
        rust = { 'rustfmt' },
        -- Go
        go = { 'gofmt', 'goimports' },
        -- Protobuf (replaces buf-format via ALE)
        proto = { 'buf' },
        -- CSS/HTML
